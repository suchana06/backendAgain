...
import {publishVideo,getVideoById,updateVideo,updateThumbnail,togglePublishStatus,deleteVideo} from '../controllers/video.controller.js';
const router = Router();
...
router.route("/videoDelete/:videoId").delete(verifyJWT,deleteVideo)
